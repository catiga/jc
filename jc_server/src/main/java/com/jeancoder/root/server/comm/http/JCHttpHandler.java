...
public class JCHttpHandler extends ChannelInboundHandlerAdapter {
	...
	public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
		if (!(msg instanceof HttpRequest)) {
			String result = "unsupport request types!------From JC Server";
		...
		try {
			...
			writeResponse(ctx.channel(), HttpResponseStatus.OK, SUCCESS, true);
		} catch (Exception e) {
